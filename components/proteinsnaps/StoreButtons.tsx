...
export function StoreButtons({
  ...
  const playClass =
    variant === "hero"
      ? "ps-play-button"
      : "ps-glow-button border border-[#00e6a8]/40 bg-[#00e6a8]/10 font-medium text-[#00e6a8] hover:bg-[#00e6a8]/20";
  const appStoreClass =
    variant === "hero"
      ? "ps-appstore-button"
  ...
  return (
    <div className={className}>
      <div className="flex flex-col items-stretch gap-6 sm:flex-row sm:items-start sm:justify-center sm:gap-8">
        {/* Google Play + QR */}
        <div className="flex flex-col items-center">
          <a
            ...
            className={`inline-flex items-center justify-center gap-2 rounded-full transition-all ${buttonWidth} ${btnClass} ${playClass}`}
          >
        ...
        <div className="flex flex-col items-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`inline-flex items-center justify-center gap-2 rounded-full transition-all ${buttonWidth} ${btnClass} ${appStoreClass}`}
          >
            <svg className="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          {showQr && (
            <div className="mt-4 hidden flex-col items-center md:flex">
              <div className="inline-block rounded-xl border border-[#00c2ff]/25 bg-white p-2.5 shadow-[0_0_24px_-4px_rgba(0,194,255,0.35)]">
                <QRCode
