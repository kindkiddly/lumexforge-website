  ...
  return (
    <section className="relative py-20 sm:py-24 lg:py-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeInUp>
          <div className="ps-download-cta-card ps-3d-card relative overflow-hidden rounded-3xl border border-[#00e6a8]/20 bg-gradient-to-br from-[#00e6a8]/10 via-background-secondary to-[#00c2ff]/5 px-6 py-14 text-center max-lg:bg-none sm:px-12 sm:py-16 ps-glow-frame">
