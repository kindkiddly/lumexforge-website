  ...
  return (
    <section className="relative py-20 sm:py-24 lg:py-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeInUp>
          <div className="ps-glass-panel overflow-hidden rounded-3xl border border-[#00c2ff]/20 bg-gradient-to-br from-[#00c2ff]/10 via-background-secondary to-[#00e6a8]/5 p-8 sm:p-12 ps-glow-frame">
