...
const COVERFLOW_CARDS: CoverflowCard[] = [
  ...
  },
  {
    ...
    tagline: "Premium ghostwriting, design & digital publishing · Web & Mobile",
...
const APPS: AppCard[] = [
  ...
  },
  {
    id: "ghostwriterhunt",
    name: "GhostWriterHunt",
    tagline: "Premium ghostwriting, book design & digital publishing",
    status: "Launching Soon",
    statusClass: "bg-[#C9A84C]/15 text-[#C9A84C] ring-[#C9A84C]/35",
    placeholderClass: "lf-placeholder-studio",
    iconLabel: "GR",
    imageSrc: "/images/lumexforge/LF-app/LF-APP-GR.webp",
    cta: "Learn More →",
    href: "/products#ghostwriterhunt",
    external: false,
  },
