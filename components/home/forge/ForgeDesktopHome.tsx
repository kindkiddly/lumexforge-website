...
function ProteinSnapsStoreInline() {
  return (
    <div className="lf-app-store-inline">
      <a
      ...
      <div className="lf-store-qr-box" title="Android download QR">
        <QRCode
      ...
      <div className="lf-store-qr-box" title="iOS download QR">
        <QRCode
            ...
            {APPS.map((app, index) => (
              <FadeInUp key={app.id} delay={index * 0.08}>
                <article className="lf-app-card lf-3d-card group">
                  ...
                  <div
                    className={`lf-app-card-footer${app.id === "proteinsnaps" ? " lf-app-card-footer--store" : ""}`}
                  >
                    {app.external ? (
                      <a
                        href={app.href}
                    ...
                    {app.id === "proteinsnaps" && <ProteinSnapsStoreInline />}
                  </div>
                </article>
              </FadeInUp>
            ))}
