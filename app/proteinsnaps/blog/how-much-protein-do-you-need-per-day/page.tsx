...
export default function HowMuchProteinArticlePage() {
  return (
    <BlogArticleLayout
      ...
      subtitle="A Simple Guide by Weight, Goal & Activity"
      category="Nutrition & Fitness"
      readingTime="8 min read"
      author="ProteinSnaps Nutrition Team"
      ...
      tableOfContents={[
        {
          ...
          label: "Why Is Protein So Important?",
        },
        {
        ...
        },
        {
          ...
          label: "Does Protein Timing Matter?",
        },
        {
    ...
    >
      ...
      <div className="ps-blog-steps">
        <BlogStep number={1} title="Start With Protein at Breakfast">
          <p>
        ...
        <BlogStep number={2} title="Include Protein at Lunch">
          <p>
        ...
        <BlogStep number={3} title="Plan Your Meals Around Your Goal">
          <p>
        ...
        <BlogStep number={4} title="Keep Convenient Protein Sources Available">
          <p>
        ...
        <BlogStep number={5} title="Track What You Are Actually Eating">
          <p>
      ...
      <BlogImagePlaceholder
        src="/images/proteinsnaps/blog-ps1.webp"
      ...
      <BlogSectionHeading label="Summary" accent="green">
